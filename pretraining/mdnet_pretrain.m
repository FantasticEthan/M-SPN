...
opts.seqsList  = {
   ...
   struct('dataset','vot2014','list','pretraining/seqList/vot13.txt'),...
...
nb = opts.train.numBunch;
% domain-specific layers
net.layers{end+1} = struct('type', 'conv', ...
    'name', 'fc6', ...
    'filters', 0.01 * randn(1,1,512,2*nb,'single'), ...
    'biases', zeros(1, 2*nb, 'single'), ...
    'stride', 1, ...
    'pad', 0, ...
